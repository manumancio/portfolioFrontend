...
const sobreMiInput: any = document.getElementById("sobreMiInput");
const sobreMiButton: any = document.getElementById("sobreMiButton");
const sobreMiParagraph: any = document.getElementsByClassName("sobreMiParagraph");
const sobreMiButtonMas: any = document.getElementById("sobreMiButtonMas");
const sobreMiDiv: any = document.getElementById("sobreMiDiv");
let i:number = 0
...
sobreMiInput.addEventListener("keyup", function (event:any) {
    if (i < 4) {
        if (event.key === 'Enter') {
            sobreMiInput.style.display = "none";
...
// // FORMACION ACADEMICA
const academicaLi1:any = document.getElementById('academicaLi1')
const academicaLi2:any = document.getElementById('academicaLi2')
const academicaButton:any = document.getElementById('academicaButton')
const academicaInputParagraph:any = document.getElementsByClassName('academicaInputParagraph')
const academicaInputTitle:any = document.getElementsByClassName('academicaInputTitle')
const academicaTitle:any = document.getElementsByClassName('academicaTitle')
const academicaParagraph:any = document.getElementsByClassName('academicaParagraph')
const itemIcono:any = document.getElementsByClassName('itemIcono')
const academicaButtonMas:any = document.getElementById('academicaButtonMas')
...
academicaInputTitle[0].addEventListener("keyup", function (event:any) {
    if (event.key === 'Enter') {
...
academicaInputParagraph[0].addEventListener("keyup", function (event:any) {
    if (event.key === 'Enter') {
...
academicaButtonMas.addEventListener('click', () => {
    ...
    // funcion para fijar el texto al titulo
    academicaInputTitle[1].addEventListener("keyup", function (event:any) {
        if (event.key === 'Enter') {
    ...
    // funcion para fijar el texto al parrafo
    academicaInputParagraph[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
...
const cursosLi1:any = document.getElementById('cursosLi1')
const cursosLi2:any = document.getElementById('cursosLi2')
const cursosButton:any = document.getElementById('cursosButton')
const cursosInputParagraph:any = document.getElementsByClassName('cursosInputParagraph')
const cursosInputTitle:any = document.getElementsByClassName('cursosInputTitle')
const cursosTitle:any = document.getElementsByClassName('cursosTitle')
const cursosParagraph:any = document.getElementsByClassName('cursosParagraph')
const cursosButtonMas: any = document.getElementById('cursosButtonMas')
...
// funcion para fijar el texto al titulo
cursosInputTitle[0].addEventListener("keyup", function (event: any) {
    if (event.key === 'Enter') {
...
// funcion para fijar el texto al parrafo
cursosInputParagraph[0].addEventListener("keyup", function (event: any) {
    if (event.key === 'Enter') {
...
cursosButtonMas.addEventListener('click', () => {
    ...
    // funcion para fijar el texto al titulo
    cursosInputTitle[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
    ...
    // funcion para fijar el texto al parrafo
    cursosInputParagraph[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
...
const idiomasLi1:any = document.getElementById('idiomasLi1')
const idiomasLi2:any = document.getElementById('idiomasLi2')
const idiomasButton:any = document.getElementById('idiomasButton')

const idiomasInputTitle:any = document.getElementsByClassName('idiomasInputTitle')
const idiomasTitle:any = document.getElementsByClassName('idiomasTitle')

const idiomasButtonMas:any = document.getElementById('idiomasButtonMas')
...
// funcion para fijar el texto al titulo
idiomasInputTitle[0].addEventListener("keyup", function (event: any) {
    if (event.key === 'Enter') {
...
idiomasButtonMas.addEventListener('click', () => {
    ...
    // funcion para fijar el texto al titulo
    idiomasInputTitle[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
...
const experienciaButton:any = document.getElementById('experienciaButton')
const experienciaInputParagraph1:any = document.getElementsByClassName('experienciaInputParagraph1')
const experienciaInputParagraph2:any = document.getElementsByClassName('experienciaInputParagraph2')
const experienciaInputTitle:any = document.getElementsByClassName('experienciaInputTitle')
const experienciaTitle:any = document.getElementsByClassName('experienciaTitle')
const experienciaParagraph1:any = document.getElementsByClassName('experienciaParagraph1')
const experienciaParagraph2:any = document.getElementsByClassName('experienciaParagraph2')
const experienciaButtonMas:any = document.getElementById('experienciaButtonMas')
...
// funcion para fijar el texto al titulo
experienciaInputTitle[0].addEventListener("keyup", function (event: any) {
    if (event.key === 'Enter') {
...
experienciaInputParagraph1[0].addEventListener("keyup", function (event: any) {
    if (event.key === 'Enter') {
...
experienciaInputParagraph2[0].addEventListener("keyup", function (event: any) {
    if (event.key === 'Enter') {
...
experienciaButtonMas.addEventListener('click', () => {
    ...
    // funcion para fijar el texto al titulo
    experienciaInputTitle[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
    ...
    // funcion para fijar el texto al parrafo1
    experienciaInputParagraph1[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
    ...
    // funcion para fijar el texto al parrafo2
    experienciaInputParagraph2[1].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
...
experienciaButtonMas.addEventListener('click', () => {
    ...
    // funcion para fijar el texto al titulo
    experienciaInputTitle[2].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
    ...
    // funcion para fijar el texto al parrafo1
    experienciaInputParagraph1[2].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
    ...
    // funcion para fijar el texto al parrafo2
    experienciaInputParagraph2[2].addEventListener("keyup", function (event: any) {
        if (event.key === 'Enter') {
...
const buttonHamburguesa:any = document.getElementById('buttonHamburguesa');
const buttonHamburguesaCerrar:any = document.getElementById('buttonHamburguesaCerrar');
const divHamburguesa:any = document.getElementById('divHamburguesa');
const menuHamburguesaUl:any = document.getElementById('menuHamburguesaUl');

const heroFilter:any = document.getElementById('heroFilter')
const mainFilter:any = document.getElementById('mainFilter')
const footerFilter:any = document.getElementById('footerFilter')
